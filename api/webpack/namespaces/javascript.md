...
* `currentTagData` {Record|CommonJsImportSettings|CompatibilitySettings|HarmonySettings|HarmonySpecifierGuards|ImportSettings|TopLevelSymbol}
...
* `name` {string}
* `tag` {symbol}
* Returns: {Record|CommonJsImportSettings|CompatibilitySettings|HarmonySettings|HarmonySpecifierGuards|ImportSettings|TopLevelSymbol}
...
* `name` {string}
* `tag` {symbol}
* `data` {Record|CommonJsImportSettings|CompatibilitySettings|HarmonySettings|HarmonySpecifierGuards|ImportSettings|TopLevelSymbol}
* `flags` {0|1|2|4}
* Returns: {void}
